...
def import_clips(
    ...
    source_type: Optional[str] = typer.Option(None, "--source-type", help="Override source_type for entries without manifest data"),
    ...
    try:
        ...
        jsonl_emit_error(stage="import", detail=f"Scan failed: {exc}", error_code=ErrorCode.IMPORT_SCAN_ERROR)
